                  ...
                  builder: (context,snapshot) {
                    ...
                    return ScopedModelDescendant<DataModel>(builder: (context, child, model) {
                      ...
                      return recentChat.userData.isNotEmpty
                        ...
                        Column(
                            children: [
                              ...recentChat.messageWidgetList.asMap().entries.map((e) => e.value)
                            ],
                          ...
                          children: [
                            Image.asset(eImageAssets.noChat,height: Sizes.s150),
                            Text(appFonts.noChat.tr,style: AppCss.manropeBold16.textColor(appCtrl.appTheme.darkText)).paddingSymmetric(vertical: Insets.i10),
                            Text(appFonts.thereIsNoChat.tr,textAlign: TextAlign.center,style: AppCss.manropeMedium14.textColor(appCtrl.appTheme.greyText).textHeight(1.5))
                          ]
                      ).paddingSymmetric(horizontal: Insets.i20).alignment(Alignment.center);
                    }
                    );
