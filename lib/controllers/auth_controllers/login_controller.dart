                        ...
                        IntrinsicHeight(
                          child: Row(
                            children: [
                              ...
                              Expanded(
                                child:  Text(appFonts.cancel.tr,textAlign: TextAlign.center, style:GoogleFonts.manrope(
                                    color: appCtrl.appTheme.greyText,
                                    fontWeight: FontWeight.w500,
                                    fontSize: 14
                                )).paddingSymmetric(vertical: Insets.i18).inkWell(  onTap: () async {
                                  Get.back();
                              ...
                              Expanded(
                                child:  Text(appFonts.accept.tr,textAlign: TextAlign.center, style:GoogleFonts.manrope(
